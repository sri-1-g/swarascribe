...
with col2:
    st.image("upload.png")
st.write("Currently, the AI can only analyse the following ragams: Kharaharapriya, Shankarabharanam, Todi, Bhairavi, and Kalyani. Don't worry, more are to come!")
